                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li><a href="manage-mechanics.php">Manage Mechanics</a></li>
														...
														<li>
                                <a href="javascript: void(0);"><i class="fi-layers"></i><span> Vehicle Inventory </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="add-category.php">Add Vehicle</a></li>
                                    <li><a href="manage-category.php">Manage Vehicle</a></li>
                                </ul>
                            </li>
							...
							<li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="reg-user.php">Active Users</a></li>
                                    <li><a href="reg-user.php">All Users</a></li>
									<li><a href="manage-category.php">Add Users</a></li>
                                </ul>
                            </li>
