...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
    <div class="container">
      <!-- <a class="navbar-brand js-scroll-trigger" href="#page-top">CE ERP</a> -->
  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="container">
      <img class="img-fluid mb-5 d-block mx-auto" src="img/architecture1216056.jpg"  height="200" width="200">
      <h1 class="text-uppercase mb-0">Clark Enersen ERP</h1>
      <hr class="star-light">
  ...
  <div class="copyright py-4 text-center text-white">
    <div class="container">
      <small>Copyright &copy;  Clark Enersen ERP 2022</small>
    </div>
  </div>
