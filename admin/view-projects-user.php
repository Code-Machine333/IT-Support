                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box shadow">
                                    <h4 class="m-t-0 header-title">Your Projects
                                        ...
                                        <div class="col-12">
                                            <div class="p-20">
                                                <table class="styled-table" id="dataTable">
                                                    ...
                                                    $ret = mysqli_query($con, "SELECT DISTINCT tbluser.FullName, tblprojects.id, tblprojects.project_number, tblprojects.projectname, tblprojects.status_id, tblProjectStatus.StatusName
																			FROM (((tblProjectTeam
