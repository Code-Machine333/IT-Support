                                            ...
                                            <div class="p-20">
                                                ...
                                                ?>
                                                    ...
                                                    <form class="form-horizontal" role="form" method="post" name="submit">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-2 col-form-label" for="example-email">Active</label>
                                                            <div class="col-10">
                                                                <input type="checkbox" id="active" name="active" class="form-control" required="true" value="<?php echo $row['Address']; ?>">
                                                            </div>
                                                        </div>
