                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box shadow">
                                    <h4 class="m-t-0 header-title">Discipline Projects
                                        ...
                                        <div class="col-12">
                                            <div class="p-20">
                                                <table class="styled-table" id="dataTable">
                                                    ...
                                                    $ret = mysqli_query($con, "Select distinct tblprojects.id, tblprojects.project_number, tblprojects.projectname, tbluser.ID, tbluser.FullName, tbldiscipline.DisciplineName
																				from (((tblProjectTeam
																				LEFT JOIN tblprojects ON tblProjectTeam.project_id = tblprojects.id)
																				Left JOIN tbldiscipline ON tblProjectTeam.proj_disc = tbldiscipline.id)
																				left JOIN tbluser ON tblProjectTeam.employee_id = tbluser.ID)
																				where tbluser.ID = '$managed_by' and tblprojects.active = 'yes'
																				; ");
                                                    $cnt = 1;
