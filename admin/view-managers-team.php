                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box shadow">
                                    <h4 class="m-t-0 header-title pb-5">Managed Team
                                            ...
                                            <div class="col-12">
                                                <div class="p-20">
                                                            ...
                                                            <?php
                                                                ...
                                                                $ret=mysqli_query($con,"select ID, FullName from tbluser where fk_reports = '$managed_by' order by FullName ASC");
                                                            ...
                                                            <table class="styled-table mt-2 mb-5">                                                        
                                                                <thead>
                                                                    <tr>
                                                                        <th style="width:30rem;">Project Number</th>
                                                                        <th>Project Name</th>
                                                                    </tr>
                                                                </thead>                                               
                                                                    <?php
                                                                        ...
                                                                        $retb = mysqli_query($con, "SELECT tbluser.FullName, tblprojects.id, tblprojects.project_number, tblprojects.projectname
                                                                                        ...
                                                                                        where tblProjectTeam.Deleted = '1' and tbluser.fk_reports = '$managed_by';");
