                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box shadow">
                                    <h4 class="m-t-0 header-title">View Task <?php echo $custid; ?></h4>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="p-20">
                                                ...
                                                $cid = substr(base64_decode($_GET['custid']), 0, -5);
                                                $custid = ($_GET['custid']);
                                                $ret = mysqli_query($con, "select a.id, a.instructions, a.active, a.date, a.employee_id, b.projectname, b.googlemap, b.location, c.scopename, d.customer_name, e.fullname
																	...
																	left JOIN customers d on d.id = b.customer_id
																	left join tbluser e on e.id = b.customer_id
																	where a.employee_id = '$custid';");
                                                ...
                                                <table border="1" class="table table-bordered mg-b-0">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="edit-task.php?taskid=<?php echo $id; ?>"><?php echo $id; ?></a>
                                                    </tr>
                                                    <tr>
                                                        <th>Customer Name</th>
