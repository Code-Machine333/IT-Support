                                        ...
                                        <div class="col-12">
                                            <div class="p-20">
                                                <table class="styled-table" id="dataTable">
                                                    ...
                                                    $ret = mysqli_query($con, "select * from tbldiscipline where active = 'yes'");
                                                    $cnt = 1;
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="view-projects-bydiscipline.php?discid=<?php echo base64_encode($row['id'] . $rno); ?>"> View Projects</a></td>
                                                        </tr>
                                                    <?php
                                                        $cnt = $cnt + 1;
                                                    } ?>
