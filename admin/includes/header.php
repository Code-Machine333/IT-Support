                ...
                <div class="topbar">
                    ...
                    <nav class="navbar-custom">
                        ...
                        <ul class="list-unstyled topbar-right-menu float-right mb-0">
							...
							$ret=mysqli_query($con,"select tblservicerequest.ServiceNumber,tblservicerequest.ID as apid,
													tbluser.FullName,tblservicerequest.ServicerequestDate
													from tblservicerequest inner join tbluser on tbluser.ID=tblservicerequest.UserId where tblservicerequest.AdminStatus is null");
                            ...
                            <li class="dropdown notification-list">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-lg">
                                    ...
                                    <a href="pending-milestones.php" class="dropdown-item text-center text-primary notify-item notify-all">
                            ...
                            <li class="dropdown notification-list">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated profile-dropdown">
                                    ...
                                    <!-- item-->
                                     <a href="edit-user-password.php?userid=<?php echo $adid;?>" class="dropdown-item notify-item">
