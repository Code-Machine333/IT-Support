                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box shadow">
                                    <h4 class="m-t-0 header-title">Manage All Tasks
                                            ...
                                            <div class="p-20">
                                                <table class="table mb-0">
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            <td><a href="view-task.php?custid=<?php echo base64_encode($row['id'] . $rno); ?>"><?php echo " $row[id] - $row[customer_name] - $row[projectname] "; ?></a></td>
